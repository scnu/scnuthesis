...
本模板推荐使用 BIB\TeX，样式文件为 gbt7714-numerical.bst，这个文件是 GB/T 7714—2015《信息与文献 参考文献著录规则》中国参考文献推荐标准的 BIB\TeX 实现。国内的绝大部分学术期刊、学位论文都使用了基于该标准的格式。该 bst 文件天然支持各种中文参考文献格式，同时本项目使用做了一些配置上的改动以使用本校的使用习惯。

看看这个例子，关于书的\upcite{tex, companion}，
